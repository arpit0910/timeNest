...
class AttendanceWorklogPolicyService
{
    ...
    /**
     * Resolve the worklog policy for a corporation.
     */
    public function getWorklogPolicyForCorporation(Corporation $corporation): AttendanceWorklogPolicy
    {
     ...
     */
    public function getOrCreateWorklogPolicy(AttendancePolicy $policy): AttendanceWorklogPolicy
    {
        return AttendanceWorklogPolicy::firstOrCreate([
     ...
     */
    public function updateWorklogPolicy(AttendancePolicy $policy, array $data): AttendanceWorklogPolicy
    {
