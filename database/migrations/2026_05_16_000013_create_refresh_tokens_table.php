...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('refresh_tokens', function (Blueprint $table) {
            ...
            $table->string('guard', 20)->default('organization')->comment('platform | organization');
            $table->unsignedBigInteger('organization_id')->nullable()->comment('Active organization at issuance');
