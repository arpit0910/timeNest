...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('organizations', function (Blueprint $table) {
            ...
            // Branding
            $table->string('logo_url', 500)->nullable()->comment('Organization logo URL');
            ...
            // Settings & features
            $table->json('settings')->nullable()->comment('Organization-level settings JSON');
            $table->json('feature_flags')->nullable()->comment('Per-organization feature toggle overrides');
        ...
        if (DB::getDriverName() === 'mysql') {
            DB::statement("ALTER TABLE organizations ADD CONSTRAINT chk_organizations_phone 
