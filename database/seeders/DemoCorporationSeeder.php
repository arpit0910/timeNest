...
/**
 * Seeds a demo corporation with branches, departments, and sample users.
 *
 * Only runs in non-production environments.
 */
class DemoCorporationSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        DB::transaction(function () {
            ...
            $ownerMembership = CorpMembership::create([
                'uuid' => (string) Str::uuid(),
                'user_id' => $owner->id,
                'corporation_id' => $corp->id,
            ...
            EmployeeProfile::create([
                ...
                'user_id' => $owner->id,
                'corporation_id' => $corp->id,
                'corp_membership_id' => $ownerMembership->id,
            ...
            $empMembership = CorpMembership::create([
                'uuid' => (string) Str::uuid(),
                'user_id' => $emp->id,
                'corporation_id' => $corp->id,
                'status' => MembershipStatus::Active,
            ...
            EmployeeProfile::create([
                ...
                'user_id' => $emp->id,
                'corporation_id' => $corp->id,
                'corp_membership_id' => $empMembership->id,
        ...
        $this->command->info('Seeded demo corporation with branches, departments, and users.');
    }
}
