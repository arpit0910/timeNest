<section class="relative py-24 bg-surface overflow-hidden {{ $class }}">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
        <h2 class="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-content-strong mb-4">{{ $headline }}</h2>
        @if($subheadline)
            <p class="text-content-muted text-lg mb-8">{{ $subheadline }}</p>
        @endif
