...
>
     <div class="flex items-center justify-between">
         <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Freelancer Invoice</span>
     ...
     <div class="mt-3 flex items-center justify-between text-xs flex-1">
         <div>
             <p class="font-bold text-neutral-700 text-[10px]">Client: Acme Corp</p>
             <p class="text-[9px] text-neutral-500 font-semibold mt-0.5" x-text="'₹' + amount.toLocaleString()"></p>
         </div>
         <div :class="'flex items-center justify-center w-6 h-6 rounded-full border transition-all duration-500 ' + (paid ? 'bg-emerald-500 border-emerald-500 text-white scale-110 shadow-sm shadow-emerald-500/30' : 'bg-neutral-50 border-neutral-200 text-neutral-400')">
