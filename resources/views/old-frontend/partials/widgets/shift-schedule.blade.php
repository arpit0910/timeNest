...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Shift Scheduling</span>
        </div>
        ...
        <template x-for="emp in roster" :key="emp.name">
            <div class="bg-neutral-50 border border-neutral-100 p-2 rounded-xl flex items-center justify-between transition-all duration-500">
                <div class="flex flex-col text-left">
                    ...
                    <span class="text-[8px] text-neutral-400 font-mono" x-text="emp.shift"></span>
                </div>
