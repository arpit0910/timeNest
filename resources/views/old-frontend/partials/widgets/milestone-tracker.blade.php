...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Milestones</span>
        </div>
        <span class="text-[8px] font-bold text-neutral-400 uppercase tracking-wider">3 Stages</span>
    </div>
    
    <div class="mt-2 space-y-1.5 flex-1 flex flex-col justify-center">
        <template x-for="ms in milestones" :key="ms.label">
            <div class="flex items-center justify-between p-1 border border-neutral-100 rounded-lg bg-neutral-50/50">
                <span class="text-[10px] font-semibold text-neutral-700" x-text="ms.label"></span>
                <div :class="'w-4.5 h-4.5 rounded-full flex items-center justify-center border transition-all duration-500 ' + 
                     (ms.complete ? 'bg-emerald-500 border-emerald-500 text-white' : 'bg-white border-neutral-200 text-neutral-350')"
                >
