...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Expense Tracker</span>
        </div>
        <span class="text-[8px] font-bold text-neutral-400 uppercase tracking-wider font-mono">Month: Q2</span>
    </div>
        ...
        <template x-for="item in expenses" :key="item.label">
            <div class="bg-neutral-50 border border-neutral-100 p-2 rounded-xl flex items-center justify-between transition-all duration-500">
                <div class="flex flex-col text-left">
                    <span class="text-[10px] font-bold text-neutral-700" x-text="item.label"></span>
                    <span class="text-[9px] text-neutral-800 font-bold font-mono" x-text="'$' + item.amount.toFixed(2)"></span>
                </div>
