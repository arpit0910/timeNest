...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Asset Management</span>
        </div>
        <span class="text-[8px] font-bold text-neutral-400 uppercase tracking-wider">Inventory</span>
    </div>
    ...
    <div class="mt-2 space-y-2 flex-1 flex flex-col justify-center">
        <template x-for="ast in assets" :key="ast.label">
            <div class="bg-neutral-50 border border-neutral-100 p-2 rounded-xl flex items-center justify-between transition-all duration-500">
                <div class="text-left">
                    <span class="text-[10px] font-bold text-neutral-700 block" x-text="ast.label"></span>
                    <span class="text-[7px] text-neutral-400 font-bold uppercase" x-text="ast.type"></span>
                </div>
