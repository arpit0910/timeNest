...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Workforce Summary</span>
        </div>
        <span class="text-[9px] text-neutral-400 font-semibold">93.3% Online</span>
    </div>
    ...
    <div class="flex items-center justify-around my-2">
        ...
        <div class="relative w-14 h-14 flex items-center justify-center">
            ...
            <div class="absolute text-[10px] font-bold text-neutral-700">
                <span x-text="active"></span>/<span x-text="total"></span>
            </div>
        </div>
        
        <div class="space-y-1 text-left">
            <div class="flex items-center gap-1.5 text-[9px] font-semibold text-neutral-600">
    ...
    <div class="border-t border-neutral-100 pt-2 flex items-center justify-between text-[9px] font-semibold text-neutral-400">
