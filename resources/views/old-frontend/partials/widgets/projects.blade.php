...
>
     <div class="flex items-center justify-between">
         <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Project Progress</span>
     ...
     <div class="space-y-1.5 flex-1 flex flex-col justify-end mt-1">
         <div class="bg-neutral-50 border border-neutral-100 p-1.5 rounded-lg">
             <div class="flex justify-between items-center text-[10px] mb-0.5">
                 <span class="text-neutral-800 font-bold">TimeNest Launch</span>
                 <span class="text-neutral-500 font-bold" x-text="progress + '%'"></span>
             </div>
         ...
         <div class="space-y-0.5">
             <template x-for="task in tasks">
                 <div class="flex items-center justify-between text-[9px]">
                     <span class="font-semibold text-neutral-600" x-text="task.name"></span>
                     <span :class="'text-[8px] font-bold ' + 
                           (task.status === 'done' ? 'text-emerald-600' : task.status === 'doing' ? 'text-indigo-600 animate-pulse' : 'text-neutral-400')"
