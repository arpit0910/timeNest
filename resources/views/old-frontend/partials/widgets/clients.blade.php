...
>
    <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Clients CRM</span>
    ...
    <div class="mt-2 space-y-1.5 flex-1 flex flex-col justify-center">
        <div class="flex items-center justify-between text-[11px]">
            <span class="font-bold text-slate-700" x-text="client"></span>
        ...
        <div class="flex gap-1 h-1.5 my-1">
            ...
            <div class="flex-1 rounded-sm transition-all duration-500" :class="idx >= 2 ? 'bg-emerald-500' : 'bg-slate-200'"></div>
        </div>
    </div>
</div>
