...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Kanban Board</span>
        </div>
    ...
    <div class="grid grid-cols-3 gap-1.5 my-2.5">
        <div class="bg-neutral-50 border border-neutral-100 p-1.5 rounded-lg text-center h-[52px] flex flex-col justify-between">
            <span class="text-[7px] text-neutral-400 font-bold uppercase">To Do</span>
            <div class="h-4"></div>
        </div>
        
        <div class="bg-neutral-50 border border-neutral-100 p-1.5 rounded-lg text-center h-[52px] flex flex-col justify-between relative overflow-hidden">
            <span class="text-[7px] text-neutral-400 font-bold uppercase">In Progress</span>
            <div x-show="currentCol === 'Progress'" x-transition class="bg-white border border-neutral-200/80 rounded px-1 py-0.5 shadow-xs text-[7px] font-bold text-neutral-700 truncate leading-none">
                Secure SSL
            </div>
        </div>
        
        <div class="bg-neutral-50 border border-neutral-100 p-1.5 rounded-lg text-center h-[52px] flex flex-col justify-between relative overflow-hidden">
            <span class="text-[7px] text-neutral-400 font-bold uppercase">Completed</span>
