...
>
     <div class="flex items-center justify-between">
         <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider font-body">Sales Pipeline</span>
     ...
     <div class="mt-2 space-y-1 flex-1 flex flex-col justify-end">
         <div class="flex justify-between items-center text-[9px]">
             <span class="text-neutral-400 font-semibold">Pipeline Value</span>
             <span class="font-bold text-neutral-800">₹9.7L</span>
         </div>
         ...
         <div class="flex gap-1 h-1.5 my-1.5">
             ...
             <div class="flex-1 rounded-sm transition-all duration-500" :class="idx >= 2 ? 'bg-indigo-300' : 'bg-neutral-200'"></div>
             <div class="flex-1 rounded-sm transition-all duration-500" :class="idx >= 3 ? 'bg-emerald-500' : 'bg-neutral-200'"></div>
         </div>
         <div class="bg-neutral-50 border border-neutral-100 rounded-lg p-1 flex flex-col gap-0.5 transition-all duration-300">
             <span class="text-[7px] text-neutral-400 font-bold uppercase">Active Deal</span>
             <div class="flex justify-between items-center text-[9px]">
                 <span class="font-bold text-neutral-700 truncate max-w-[80px]" x-text="deals[idx % 3].name"></span>
