...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Role Permission Matrix</span>
        </div>
        <span class="text-[8px] font-bold text-neutral-400 uppercase tracking-wider font-mono">RBAC</span>
    </div>
    
    <div class="mt-2 space-y-1.5 flex-1 flex flex-col justify-center">
        <template x-for="r in roles" :key="r.name">
            <div class="flex items-center justify-between p-1.5 bg-neutral-50 border border-neutral-100 rounded-lg">
                <span class="text-[10px] font-bold text-neutral-700 w-1/3" x-text="r.name"></span>
                
                <div class="flex items-center gap-3 w-2/3 justify-end text-[8px] font-bold">
                    <div class="flex items-center gap-1">
                        <span class="text-neutral-450">Read</span>
                    ...
                    <div class="flex items-center gap-1">
                        <span class="text-neutral-450">Write</span>
                        <div :class="'w-6 h-3.5 rounded-full p-0.5 transition-all cursor-pointer ' + (r.write ? 'bg-indigo-500' : 'bg-neutral-300')">
