...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Client Revenue</span>
        </div>
        <span class="text-[8px] font-bold text-neutral-400 uppercase tracking-wider">Live</span>
    </div>
        ...
        <template x-for="c in clients" :key="c.name">
            <div class="flex items-center justify-between p-2 bg-neutral-50/50 border border-neutral-100 rounded-xl">
                <div class="flex flex-col text-left">
                    <span class="text-[10px] font-bold text-neutral-700" x-text="c.name"></span>
                    <span class="text-[7px] text-neutral-400 font-bold uppercase">Monthly Billed</span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="text-[11px] font-bold text-neutral-800 font-mono" x-text="'$' + c.revenue.toLocaleString()"></span>
