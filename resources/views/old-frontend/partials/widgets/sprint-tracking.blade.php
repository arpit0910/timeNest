...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Sprint Tracker</span>
        </div>
        <span class="text-[8px] font-bold text-neutral-400 font-mono">Sprint 14</span>
    </div>
    
    <div class="my-2 space-y-2 flex-1 flex flex-col justify-center">
        <div class="bg-neutral-50 border border-neutral-100 p-2 rounded-xl flex items-center justify-between">
            <div class="text-left">
                <p class="text-[7px] text-neutral-400 font-bold uppercase">Progress</p>
                <p class="text-[11px] font-bold text-neutral-800"><span x-text="progress"></span>% Complete</p>
            </div>
            <div class="text-right">
                <p class="text-[7px] text-neutral-400 font-bold uppercase">Tasks Resolved</p>
