...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Approval Workflow</span>
        </div>
        <span class="text-[8px] font-bold text-neutral-400 uppercase tracking-wider">Leave Request #18</span>
    </div>
    
    <div class="flex items-center justify-between my-2.5 relative">
        <!-- Connecting Line -->
        <div class="absolute top-[18px] left-[15%] right-[15%] h-0.5 bg-neutral-100 z-0">
        ...
        <template x-for="(stage, idx) in stages" :key="stage.name">
            <div class="flex flex-col items-center z-10 w-1/3">
                ...
                <span class="text-[9px] font-bold text-neutral-600 mt-1" x-text="stage.name"></span>
                <span class="text-[7px] font-semibold text-neutral-400 uppercase mt-0.5" x-text="stage.status"></span>
            </div>
        </template>
    </div>
</div>
