...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">AI Operations Insights</span>
        </div>
    ...
    <div class="my-2 p-2 bg-neutral-900 border border-neutral-950 rounded-xl flex items-center justify-between min-h-[50px] shadow-inner select-none transition-all duration-500">
    ...
    <div class="flex items-center justify-between text-[8px] font-bold">
        <span class="text-neutral-400 uppercase">Status</span>
