...
>
    <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Team Status</span>
        <span :class="'text-[9px] font-semibold px-2 py-0.5 rounded-full border transition-all duration-500 ' + 
              (employees.filter(e => e.status === 'active').length >= 2 ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 'bg-neutral-50 text-neutral-600 border-neutral-200')" 
        ...
        <template x-for="emp in employees">
            <div class="flex items-center justify-between text-[11px] transition-all duration-300">
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="font-semibold text-neutral-700" x-text="emp.name"></span>
                </div>
