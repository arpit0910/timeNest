...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-neutral-500 uppercase tracking-wider">Workforce Activity Heatmap</span>
        </div>
        <span class="text-[8px] font-bold text-neutral-400 uppercase tracking-wider">Weekly Coverage</span>
    </div>
            ...
            <div class="flex gap-1">
                <template x-for="(cell, cIdx) in row" :key="cIdx">
                    <div :class="'w-6 h-4 rounded transition-all duration-500 ' + 
                         (cell === 0 ? 'bg-neutral-50 border border-neutral-100' :
