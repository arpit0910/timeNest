...
<head>
    ...
    {{-- Bootstrap supplies the shared responsive container and grid primitives. --}}
...
@php echo strtr(ob_get_clean(), $marketingCharacterRepairs); @endphp
