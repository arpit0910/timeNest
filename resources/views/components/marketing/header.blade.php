    ...
    <div class="px-6 py-3 mx-auto max-w-7xl flex items-center justify-between">
        ...
        <a href="/" class="flex items-center gap-2 group outline-none">
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' class="w-8 h-8 transition-transform group-hover:scale-105">
                <path d='M28 16 A12 12 0 1 0 16 28' stroke="#9b7dd0" stroke-width='1.8' fill='none' stroke-linecap='round'/>
                <path d='M23 16 A7 7 0 1 0 16 23' stroke="#e2e8f0" stroke-width='1.8' fill='none' stroke-linecap='round'/>
                <path d='M19 16 A3 3 0 1 0 16 19' stroke="#e2e8f0" stroke-width='1.8' fill='none' stroke-linecap='round'/>
            </svg>
            <span class="font-bold text-xl tracking-tight text-white transition-colors duration-300">TimeNest</span>
        </a>
        ...
        <div class="hidden lg:flex items-center gap-8">
            ...
            <div class="flex items-center gap-4">
                <x-ui.button variant="secondary" href="/contact" class="!px-4.5 !py-2 !text-sm !bg-white/10 !border-white/20 !text-white hover:!bg-white/20">Contact us</x-ui.button>
