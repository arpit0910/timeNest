        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div class="max-w-xl">
                ...
                <h2 class="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight mb-6">
                    ...
                    <span class="text-blue-600">flexible when you don't.</span>
                </h2>
            ...
            <div class="relative">
                ...
                <div class="bg-white border border-slate-100 shadow-xl rounded-3xl p-8 relative z-10 flex flex-col gap-6">
                    ...
                    <div class="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-start gap-3 p-3 bg-white rounded-xl border-2 border-blue-500 cursor-pointer shadow-sm">
                                <input type="radio" name="policy" checked class="mt-1 w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500">
                                <div>
                            ...
                            <label class="flex items-start gap-3 p-3 bg-white rounded-xl border border-slate-200 cursor-pointer opacity-70 hover:opacity-100 transition-opacity">
                                <input type="radio" name="policy" class="mt-1 w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500">
                                <div>
