        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                            ...
                            <div class="flex items-center gap-2 mb-4 text-xs font-medium">
                                ...
                                <div class="w-6 h-6 rounded-full bg-accent-50 text-accent-600 flex items-center justify-center animate-pulse">
            ...
            <div class="order-1 lg:order-2 max-w-xl marketing-section-copy">
                ...
                <h2 class="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight mb-6">
                    ...
                    <span class="text-accent-600">without the spreadsheets.</span>
                </h2>
