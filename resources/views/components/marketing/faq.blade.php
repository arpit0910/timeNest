<section class="py-32 bg-slate-950 relative">
    <div class="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div class="space-y-4" x-data="{ active: null }">
            ...
            {{-- FAQ 1 --}}
            <div class="border border-white/10 rounded-2xl bg-white/5 overflow-hidden transition-colors" :class="active === 1 ? 'border-accent-500/50 bg-slate-900 shadow-xl' : ''">
            ...
            {{-- FAQ 2 --}}
            <div class="border border-white/10 rounded-2xl bg-white/5 overflow-hidden transition-colors" :class="active === 2 ? 'border-accent-500/50 bg-slate-900 shadow-xl' : ''">
            ...
            {{-- FAQ 3 --}}
            <div class="border border-white/10 rounded-2xl bg-white/5 overflow-hidden transition-colors" :class="active === 3 ? 'border-accent-500/50 bg-slate-900 shadow-xl' : ''">
            ...
            {{-- FAQ 4 --}}
            <div class="border border-white/10 rounded-2xl bg-white/5 overflow-hidden transition-colors" :class="active === 4 ? 'border-accent-500/50 bg-slate-900 shadow-xl' : ''">
