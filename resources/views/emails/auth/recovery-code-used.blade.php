...
<head>
    ...
    <style>
        ...
        .alert { background-color: #eff6ff; border: 1px solid #bfdbfe; color: #1e3a8a; padding: 15px; border-radius: 6px; margin-top: 25px; font-size: 14px; }
...
<body>
    <div class="container">
        ...
        <p>A recovery code was just used to sign in to your TimeNest account.</p>
        ...
        <div class="alert">
            You have <strong>{{ $remainingCodes }}</strong> recovery code(s) remaining.
            @if($remainingCodes <= config('timenest.security.recovery_codes_low_threshold', 2))
                We recommend generating new recovery codes soon to ensure you don't lose access to your account.
            @endif
        </div>
