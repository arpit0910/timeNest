...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <h2>Hello!</h2>
                <p>You have been invited to join <strong>{{ $invitation->organization->legal_name }}</strong> on TimeNest as a <strong>{{ $invitation->role->description ?? $invitation->role->name }}</strong>.</p>
