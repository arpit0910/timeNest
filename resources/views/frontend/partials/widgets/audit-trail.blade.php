...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Audit Trail</span>
        </div>
        <span class="text-[8px] font-mono text-slate-400 uppercase">SOC2 Compliance</span>
    </div>
    
    <div class="mt-2 space-y-2 flex-1 flex flex-col justify-center">
        <template x-for="log in logs" :key="log.time">
            <div class="flex items-center justify-between p-1.5 bg-slate-50/50 border border-slate-100 rounded-xl transition-all duration-500">
                <div class="text-left">
                    <p class="text-[9px] font-bold text-slate-700 x-text" x-text="log.event"></p>
                    <p class="text-[7px] font-mono text-slate-400" x-text="log.time"></p>
                </div>
