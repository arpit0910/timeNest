...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-slate-500 uppercase tracking-wider">AI Revenue Forecast</span>
        </div>
    ...
    <div class="relative h-[60px] my-2 bg-slate-50/50 border border-slate-100 rounded-lg overflow-hidden flex items-end">
        ...
        <div class="absolute top-2 left-3 bg-white/90 backdrop-blur-xs border border-slate-150 px-1.5 py-0.5 rounded shadow-xs text-[8px] font-mono text-violet-700">
            Q3 Proj: $184K
        </div>
    </div>
    ...
    <div class="flex items-center justify-between text-[11px]">
        <div>
            <p class="text-[8px] text-slate-400 font-bold uppercase">Estimated ARR</p>
            <p class="font-bold text-slate-800 font-mono">$<span x-text="forecast.toLocaleString()"></span></p>
        </div>
