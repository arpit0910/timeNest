...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Compliance Tracker</span>
        </div>
        <span class="text-[8px] font-bold text-slate-400 uppercase tracking-wider font-mono">Audited</span>
    </div>
    ...
    <div class="mt-2 space-y-2 flex-1 flex flex-col justify-center">
        <template x-for="std in standards" :key="std.label">
            <div class="bg-slate-50 border border-slate-100 p-2 rounded-xl flex items-center justify-between transition-all duration-500">
                <div class="text-left">
                    <span class="text-[10px] font-bold text-slate-700" x-text="std.label"></span>
                    <span class="block text-[7px] text-slate-400 font-bold uppercase mt-0.5" x-text="std.val === 100 ? 'Audit Passed' : 'In Progress'"></span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="text-[10px] font-bold text-slate-800 font-mono" x-text="std.val + '%'"></span>
