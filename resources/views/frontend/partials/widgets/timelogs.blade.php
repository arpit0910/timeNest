...
>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Active Timelogs</span>
        </div>
    ...
    <div class="mt-2 space-y-2 flex-1 flex flex-col justify-center">
        <template x-for="log in logs" :key="log.dev">
            <div class="flex items-center justify-between p-2 bg-slate-50/50 border border-slate-100 rounded-xl">
                <div class="text-left">
                    <p class="text-[10px] font-bold text-slate-700 x-text" x-text="log.dev"></p>
                    <p class="text-[8px] text-slate-400 truncate max-w-[110px]" x-text="log.task"></p>
                </div>
                <div class="flex items-center gap-1.5 font-mono text-[10px] font-bold text-slate-800">
