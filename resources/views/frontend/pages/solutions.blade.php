...
@section('content')
    ...
    <main class="marketing-responsive-sections">
        ...
        <section class="min-h-[85vh] flex flex-col justify-center relative pt-32 pb-20 px-6 md:pt-40 md:pb-28 overflow-hidden bg-black">
            ...
            <div class="inline-flex flex-wrap p-1.5 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 gap-1.5 shadow-sm max-w-2xl mx-auto mt-4">
                ...
                <a href="#organizations" class="group flex items-center gap-2 px-5 py-2.5 rounded-xl bg-transparent hover:bg-white/10 transition-all duration-300 text-sm font-semibold text-neutral-400 hover:text-white">
                    <svg class="w-4 h-4 text-neutral-400 group-hover:text-emerald-600 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section id="freelancers" class="py-16 lg:py-20 bg-black border-y border-neutral-800 scroll-mt-20">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div class="order-2 lg:order-1">
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-neutral-300 font-medium">Personal time & project tracking from day one</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <div class="mt-1 w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 flex-shrink-0">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                </div>
                                <span class="text-neutral-300 font-medium">No forced organization setup</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <div class="mt-1 w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 flex-shrink-0">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                    ...
                    <div class="order-1 lg:order-2">
                        <div class="bg-white/5 rounded-3xl p-6 border border-white/10 shadow-inner">
                            <div class="bg-neutral-900 rounded-2xl shadow-sm border border-white/10 p-6">
                                <div class="flex items-center justify-between mb-6">
                                    <div>
                                        <div class="text-sm font-bold text-white">Today's Worklog</div>
                                        <div class="text-xs text-neutral-400">Personal Space</div>
                                    </div>
                                ...
                                <div class="space-y-3">
                                    <div class="p-3 border border-white/10 rounded-xl flex justify-between items-center bg-white/5">
                                        <div class="text-sm font-medium text-neutral-300">Client A - Design Review</div>
                                        <div class="text-sm font-mono text-neutral-400">02:15:00</div>
                                    </div>
                                    <div class="p-3 border border-white/10 rounded-xl flex justify-between items-center bg-white/10 shadow-sm border-l-4 border-l-indigo-500">
                                        <div class="text-sm font-medium text-neutral-300">Client B - Development</div>
        ...
        <section id="teams" class="py-16 lg:py-20 bg-neutral-50 scroll-mt-20">
            <div class="max-w-7xl mx-auto px-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div class="order-1">
                        <div class="bg-white rounded-3xl p-6 border border-neutral-200 shadow-xl shadow-neutral-200/50 relative">
                            ...
                            <div class="p-4 border border-neutral-100 rounded-xl bg-neutral-50 mb-4">
                                <div class="flex justify-between items-start mb-2">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="text-sm font-bold text-neutral-900">Maya Krishnan</div>
                                            <div class="text-xs text-neutral-500">Employee</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-xs text-neutral-600 bg-white p-2 rounded border border-neutral-100 mt-2">
                                    <span class="font-bold">Sick Leave</span> requested for tomorrow (8 hours).
                                </div>
                                <div class="flex gap-2 mt-3">
                                    <button class="flex-1 bg-white border border-neutral-200 hover:bg-neutral-50 text-neutral-700 text-xs font-bold py-1.5 rounded-lg transition">Deny</button>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center justify-between p-3 border border-neutral-100 rounded-lg">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="text-sm font-medium text-neutral-700">James Doe</div>
                                    </div>
                                    <div class="text-xs text-emerald-600 font-bold bg-emerald-50 px-2 py-0.5 rounded">Present</div>
                                </div>
                                <div class="flex items-center justify-between p-3 border border-neutral-100 rounded-lg">
                                    <div class="flex items-center gap-3">
                                        <div class="w-6 h-6 rounded-full bg-neutral-100 flex items-center justify-center text-neutral-600 font-bold text-[10px]">SJ</div>
                                        <div class="text-sm font-medium text-neutral-700">Sarah Jones</div>
                                    </div>
                                    <div class="text-xs text-neutral-500 font-bold bg-neutral-100 px-2 py-0.5 rounded">Offline</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="order-2">
                        ...
                        <ul class="space-y-4">
                            ...
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-neutral-700 font-medium">Simple roles: Admin, Manager, Employee</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <div class="mt-1 w-6 h-6 rounded-full bg-accent-100 flex items-center justify-center text-accent-600 flex-shrink-0">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                </div>
                                <span class="text-neutral-700 font-medium">Attendance and leave requests, approved in one place</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <section id="organizations" class="py-16 lg:py-20 bg-black border-y border-neutral-800 scroll-mt-20">
            <div class="max-w-7xl mx-auto px-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div class="order-2 lg:order-1">
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-neutral-300 font-medium">Departments, designations, and reporting hierarchy</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <div class="mt-1 w-6 h-6 rounded-full bg-accent-500/20 flex items-center justify-center text-accent-400 flex-shrink-0">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                </div>
                                <span class="text-neutral-300 font-medium">Multi-level approvals that follow your org chart</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <div class="mt-1 w-6 h-6 rounded-full bg-accent-500/20 flex items-center justify-center text-accent-400 flex-shrink-0">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                </div>
                                <span class="text-neutral-300 font-medium">Custom roles and permissions, configurable per organization</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <div class="mt-1 w-6 h-6 rounded-full bg-accent-500/20 flex items-center justify-center text-accent-400 flex-shrink-0">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                </div>
                                <span class="text-neutral-300 font-medium">Branch-level attendance with location verification</span>
                            </li>
                        </ul>
                    ...
                    <div class="order-1 lg:order-2">
                        <div class="bg-white/5 rounded-3xl p-6 border border-white/10 shadow-inner">
                            <div class="space-y-3 relative">
                                ...
                                <div class="relative z-10 p-3 border border-white/10 rounded-xl bg-neutral-900 shadow-sm flex items-center gap-3 ml-0">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-neutral-400">Final Approver</div>
                                    </div>
                                </div>
                                
                                <div class="relative z-10 p-3 border border-white/10 rounded-xl bg-neutral-900 shadow-sm flex items-center gap-3 ml-12">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-neutral-400">Level 1 Approver</div>
                                    </div>
                                </div>
                                
                                <div class="relative z-10 p-3 border border-white/10 rounded-xl bg-neutral-900 shadow-sm flex items-center gap-3 ml-24">
                                    <div class="absolute -left-6 top-1/2 w-6 h-0.5 bg-white/10"></div>
                                    <div class="absolute -left-12 top-[-30px] bottom-1/2 w-0.5 bg-white/10"></div>
                                    <div class="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-neutral-400">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                    </div>
                                    <div>
                                        <div class="text-sm font-bold text-white">Senior Engineer</div>
                                        <div class="text-xs text-neutral-400">Employee</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        {{-- 6. Comparison Table --}}
        <section class="py-16 lg:py-20 bg-black border-y border-neutral-800 relative">
            ...
            <div class="owl-carousel owl-theme mt-8" id="solutions-carousel">
                ...
                <div class="item h-full pb-8 pt-4">
                    <div class="relative h-full bg-neutral-900 rounded-[32px] border border-white/10 hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col group">
                            ...
                            <div class="flex-grow flex flex-col lg:flex-row items-center gap-6">
                                ...
                                <div class="w-full lg:w-[55%] relative h-full min-h-[220px] flex items-center justify-center p-4 mt-6 lg:mt-0 perspective-1000">
                                    ...
                                    <div class="relative z-10 w-full max-w-[240px] transform transition-all duration-700 -rotate-3 group-hover:rotate-0 group-hover:scale-105 group-hover:-translate-y-2">
                                        <div class="relative rounded-2xl overflow-hidden shadow-2xl border-[6px] border-neutral-700 bg-neutral-800">
        ...
        {{-- 7. FAQ --}}
        <section class="py-16 lg:py-20 bg-neutral-50 border-t border-neutral-100">
            <div class="max-w-4xl mx-auto px-6 relative z-10">
                ...
                <div x-data="{ active: null }" class="space-y-4">
                    ...
                    {{-- Q1 --}}
                    <div class="border border-neutral-200 rounded-2xl bg-white overflow-hidden shadow-sm transition-colors" :class="active === 1 ? 'border-accent-200 shadow-md' : ''">
                        <button @click="active = active === 1 ? null : 1" class="w-full flex items-center justify-between p-6 text-left focus:outline-none">
                            <span class="text-base font-bold text-neutral-900">Do I need to create an organization to use TimeNest?</span>
                    ...
                    {{-- Q2 --}}
                    <div class="border border-neutral-200 rounded-2xl bg-white overflow-hidden shadow-sm transition-colors" :class="active === 2 ? 'border-accent-200 shadow-md' : ''">
                        <button @click="active = active === 2 ? null : 2" class="w-full flex items-center justify-between p-6 text-left focus:outline-none">
                            <span class="text-base font-bold text-neutral-900">Can I start solo and upgrade to a team later?</span>
                    ...
                    {{-- Q3 --}}
                    <div class="border border-neutral-200 rounded-2xl bg-white overflow-hidden shadow-sm transition-colors" :class="active === 3 ? 'border-accent-200 shadow-md' : ''">
                        <button @click="active = active === 3 ? null : 3" class="w-full flex items-center justify-between p-6 text-left focus:outline-none">
                            <span class="text-base font-bold text-neutral-900">Can one person belong to more than one organization?</span>
                    ...
                    {{-- Q4 --}}
                    <div class="border border-neutral-200 rounded-2xl bg-white overflow-hidden shadow-sm transition-colors" :class="active === 4 ? 'border-accent-200 shadow-md' : ''">
                        <button @click="active = active === 4 ? null : 4" class="w-full flex items-center justify-between p-6 text-left focus:outline-none">
                            <span class="text-base font-bold text-neutral-900">What happens to our setup if our team grows?</span>
                    ...
                    {{-- Q5 --}}
                    <div class="border border-neutral-200 rounded-2xl bg-white overflow-hidden shadow-sm transition-colors" :class="active === 5 ? 'border-accent-200 shadow-md' : ''">
                        <button @click="active = active === 5 ? null : 5" class="w-full flex items-center justify-between p-6 text-left focus:outline-none">
                            <span class="text-base font-bold text-neutral-900">Is chat included, or is it a separate product?</span>
