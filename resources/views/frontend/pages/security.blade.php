...
@section('content')
    ...
    <main class="marketing-responsive-sections">
        ...
        <section class="py-16 lg:py-20 bg-black border-y border-neutral-800">
            <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <ul class="space-y-8">
                        <li class="flex items-start gap-4">
                            ...
                            <span class="text-neutral-300 font-semibold mt-1">Session tokens expire automatically</span>
                        </li>
                        <li class="flex items-start gap-4">
                            ...
                            <span class="text-neutral-300 font-semibold mt-1">Optional two-factor authentication per account</span>
                        </li>
                        <li class="flex items-start gap-4">
                            ...
                            <span class="text-neutral-300 font-semibold mt-1">Every device that logs in is tracked and can be revoked</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="relative w-full max-w-md mx-auto">
                    ...
                    <div class="bg-white/5 rounded-3xl shadow-none border border-white/10 p-8 relative z-10 backdrop-blur-sm">
                        ...
                        <p class="text-neutral-400 text-sm mb-6">Enter the 6-digit code from your authenticator app.</p>
                        
                        <div class="flex gap-2 justify-between mb-8">
                            <div class="w-10 md:w-12 h-14 rounded-xl border border-white/10 bg-white/5 flex items-center justify-center text-2xl font-bold text-neutral-300 shadow-inner">4</div>
                            <div class="w-10 md:w-12 h-14 rounded-xl border border-white/10 bg-white/5 flex items-center justify-center text-2xl font-bold text-neutral-300 shadow-inner">8</div>
                            <div class="w-10 md:w-12 h-14 rounded-xl border border-white/10 bg-white/5 flex items-center justify-center text-2xl font-bold text-neutral-300 shadow-inner">1</div>
        ...
        <section class="py-16 lg:py-20 bg-white overflow-hidden">
            <div class="max-w-7xl mx-auto px-6 text-center">
                ...
                <div class="flex flex-col md:flex-row items-stretch justify-center gap-6 max-w-5xl mx-auto relative">
                    ...
                    {{-- Org 1 --}}
                    <div class="bg-white border-2 border-neutral-100 rounded-3xl p-8 shadow-sm flex-1 w-full relative transform transition-transform hover:-translate-y-1">
                        <div class="w-full flex justify-center mb-6">
                            <div class="w-12 h-12 rounded-xl bg-neutral-50 border border-neutral-100 flex items-center justify-center text-neutral-400">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                            </div>
                        </div>
                        <h4 class="font-bold text-neutral-800 mb-6 border-b border-neutral-100 pb-4">Acme Corp Data</h4>
                    ...
                    <div class="hidden md:flex flex-col items-center justify-center px-2">
                        <div class="w-1 h-32 border-r-[3px] border-dashed border-neutral-200"></div>
                    </div>
                    ...
                    <div class="bg-white border-2 border-neutral-100 rounded-3xl p-8 shadow-sm flex-1 w-full relative transform transition-transform hover:-translate-y-1">
                        ...
                        <h4 class="font-bold text-neutral-800 mb-6 border-b border-neutral-100 pb-4">Global Tech Data</h4>
                        <div class="flex justify-center gap-4 text-neutral-300">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"></path></svg>
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path></svg>
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zM7 8H5v2h2V8zm2 0h2v2H9V8zm6 0h-2v2h2V8z" clip-rule="evenodd"></path></svg>
        ...
        <section class="py-16 lg:py-20 bg-black border-y border-neutral-800">
            <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="order-2 lg:order-1">
                    ...
                    <div class="bg-neutral-900 rounded-[2rem] shadow-none border border-white/10 overflow-hidden relative">
                        {{-- Header --}}
                        <div class="p-8 border-b border-white/10 bg-white/5 flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-neutral-400 mt-1">Can be customized per workspace</p>
                            </div>
                        ...
                        <div class="p-2">
                            <table class="w-full text-left text-sm border-separate border-spacing-y-3">
                                <thead>
                                    <tr>
                                        <th class="py-2 px-6 font-bold text-neutral-400 tracking-wider uppercase text-[11px]">Role Level</th>
                                        <th class="py-2 px-4 font-bold text-neutral-400 tracking-wider uppercase text-[11px] text-center w-32">
                                ...
                                <tbody>
                                        ...
                                        <td class="py-4 px-6 rounded-l-2xl border-y border-l border-white/10 bg-transparent">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-neutral-400 font-medium">Full system access</div>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="group bg-white/5 hover:bg-white/10 transition-colors shadow-sm relative border border-white/10">
                                        <td class="py-4 px-6 rounded-l-2xl border-y border-l border-white/10 bg-transparent">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-neutral-400 font-medium">Department level</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="py-4 px-2 text-center border-y border-white/10 bg-transparent">
                                        ...
                                        <td class="py-4 px-2 text-center rounded-r-2xl border-y border-r border-white/10 bg-transparent">
                                            <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-neutral-400 text-xs font-bold border border-white/20 w-[84px] justify-center">
                                    ...
                                    <tr class="group bg-white/5 hover:bg-white/10 transition-colors shadow-sm border border-white/10">
                                        <td class="py-4 px-6 rounded-l-2xl border-y border-l border-white/10 bg-transparent">
                                            <div class="flex items-center gap-4">
                                                <div class="w-12 h-12 rounded-xl bg-white/10 border border-white/20 text-neutral-300 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                                </div>
                                                <div>
                                                    <div class="font-extrabold text-white text-base mb-0.5">Employee</div>
                                                    <div class="text-xs text-neutral-400 font-medium">Personal data only</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="py-4 px-2 text-center border-y border-white/10 bg-transparent">
        ...
        <section class="py-16 lg:py-20 bg-neutral-50 border-t border-neutral-100">
            <div class="max-w-7xl mx-auto px-6 text-center">
                ...
                <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl shadow-neutral-200/50 border border-neutral-100 overflow-hidden text-left">
                    <div class="border-b border-neutral-100 p-4 bg-neutral-50 flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="font-bold text-neutral-700 text-sm">System Audit Log</span>
                        </div>
                        <span class="text-xs font-bold bg-white border border-neutral-200 text-emerald-600 px-3 py-1 rounded-full shadow-sm flex items-center gap-1.5">
                    ...
                    <div class="divide-y divide-neutral-50">
                        {{-- Log Entry 1 --}}
                        <div class="p-5 hover:bg-neutral-50/80 flex items-start gap-4 transition-colors">
                            <div class="w-10 h-10 rounded-full bg-neutral-100 text-neutral-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                            </div>
                            <div>
                                <p class="text-sm text-neutral-800 leading-relaxed"><span class="font-extrabold">Priya</span> changed <span class="font-extrabold">Rohan</span>'s role to <span class="font-bold text-accent-600 bg-accent-50 px-1.5 py-0.5 rounded">Manager</span></p>
                                <p class="text-xs text-neutral-400 mt-1.5 font-medium">2 mins ago &middot; IP 192.168.1.1</p>
                            </div>
                        </div>
                        {{-- Log Entry 2 --}}
                        <div class="p-5 hover:bg-neutral-50/80 flex items-start gap-4 transition-colors">
                            ...
                            <div>
                                <p class="text-sm text-neutral-800 leading-relaxed">New device signed in from <span class="font-extrabold">Mumbai, IN</span></p>
                                <p class="text-xs text-neutral-400 mt-1.5 font-medium">1 hour ago &middot; Chrome on Windows</p>
                            </div>
                        </div>
                        {{-- Log Entry 3 --}}
                        <div class="p-5 hover:bg-neutral-50/80 flex items-start gap-4 transition-colors">
                            ...
                            <div>
                                <p class="text-sm text-neutral-800 leading-relaxed"><span class="font-extrabold">Alex</span> approved <span class="font-extrabold">Sarah</span>'s Annual Leave request</p>
                                <p class="text-xs text-neutral-400 mt-1.5 font-medium">3 hours ago &middot; Approved via Dashboard</p>
                            </div>
                        </div>
                        {{-- Log Entry 4 --}}
                        <div class="p-5 hover:bg-neutral-50/80 flex items-start gap-4 transition-colors">
                            ...
                            <div>
                                <p class="text-sm text-neutral-800 leading-relaxed"><span class="font-extrabold">David</span> exported Monthly Attendance Report</p>
                                <p class="text-xs text-neutral-400 mt-1.5 font-medium">Yesterday at 4:30 PM &middot; CSV Format</p>
                            </div>
                        </div>
                    </div>
                </div>
