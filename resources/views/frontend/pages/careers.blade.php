<x-frontend-layout.app metaTitle="Careers â€” TimeNest" metaDescription="Join the TimeNest team. Build the future of work management.">
    <section class="relative pt-32 pb-20 bg-surface">
        <div class="max-w-4xl mx-auto px-6 lg:px-8">
            <x-frontend-sections.section-header title="Join TimeNest" subtitle="We're building the future of work management. Come build it with us." badge="Careers" />
