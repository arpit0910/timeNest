...
<main class="marketing-responsive-sections min-h-screen relative overflow-hidden">
    ...
    <section class="relative pt-44 lg:pt-56 pb-16 px-6 z-10 bg-black">
        ...
        <div class="relative max-w-4xl mx-auto flex flex-col items-center text-center z-10">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold text-white tracking-tight mb-8 leading-[1.1]">
                ...
                <span class="text-neutral-300">Your Team</span>
            </h1>
    ...
    <section class="relative py-16 lg:py-20 bg-black z-10 overflow-hidden">
        ...
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px] relative z-10">
            <div class="max-w-7xl mx-auto">
                <div class="mb-16 flex flex-col items-center text-center">
                    ...
                    <p class="text-lg text-neutral-400 max-w-2xl mx-auto">A quick starting point, so your message lands with the right context.</p>
                </div>
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="p-6 bg-white/5 rounded-2xl border border-white/10 shadow-none hover:border-white/20 transition-all cursor-pointer group">
                        ...
                        <p class="text-sm text-neutral-400 leading-relaxed">Figuring out what fits your team size and needs.</p>
                    </div>
                    {{-- Reason 2 --}}
                    <div class="p-6 bg-white/5 rounded-2xl border border-white/10 shadow-none hover:border-white/20 transition-all cursor-pointer group">
                        <div class="w-10 h-10 rounded-xl bg-accent-50 text-accent-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                        ...
                        <p class="text-sm text-neutral-400 leading-relaxed">Want to see TimeNest in action before signing up.</p>
                    </div>
                    {{-- Reason 3 --}}
                    <div class="p-6 bg-white/5 rounded-2xl border border-white/10 shadow-none hover:border-white/20 transition-all cursor-pointer group">
                        ...
                        <p class="text-sm text-neutral-400 leading-relaxed">Already using TimeNest and running into an issue.</p>
                    </div>
                    {{-- Reason 4 --}}
                    <div class="p-6 bg-white/5 rounded-2xl border border-white/10 shadow-none hover:border-white/20 transition-all cursor-pointer group">
                        ...
                        <p class="text-sm text-neutral-400 leading-relaxed">Interested in working with TimeNest in some other way.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="relative py-16 lg:py-24 bg-neutral-50 z-10 overflow-hidden">
        ...
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px] relative z-10">
            <div class="grid lg:grid-cols-12 gap-16 xl:gap-24 items-center max-w-7xl mx-auto">
                ...
                <div class="lg:col-span-7 bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-neutral-200/50 border border-neutral-100 relative overflow-hidden" x-data="{
                    name: '',
                    email: '',
                    organization: '',
                    ...
                    <div class="relative z-10">
                        <div x-show="!success">
                            <h2 class="text-3xl font-bold text-neutral-900 mb-2">Send Us a Message</h2>
                            <p class="text-neutral-500 mb-8">Fill this out and we'll get back to you.</p>

                            <form @submit.prevent="submitForm()" class="space-y-6">
                                <div class="grid md:grid-cols-2 gap-6">
                                    {{-- Full Name --}}
                                    <div>
                                        <label for="name" class="block text-sm font-semibold text-neutral-700 mb-2">Full Name</label>
                                        <input type="text" id="name" x-model="name" class="w-full bg-neutral-50 border border-neutral-200 text-neutral-900 text-sm rounded-xl focus:ring-2 focus:ring-accent-500 focus:border-accent-500 block p-3 transition-colors hover:border-neutral-300" placeholder="Jane Doe" required>
                                    </div>
                                    {{-- Email Address --}}
                                    <div>
                                        <label for="email" class="block text-sm font-semibold text-neutral-700 mb-2">Email Address</label>
                                        <input type="email" id="email" x-model="email" class="w-full bg-neutral-50 border border-neutral-200 text-neutral-900 text-sm rounded-xl focus:ring-2 focus:ring-accent-500 focus:border-accent-500 block p-3 transition-colors hover:border-neutral-300" placeholder="jane@example.com" required>
                                    </div>
                                </div>
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    {{-- Organization Name --}}
                                    <div>
                                        <label for="organization" class="block text-sm font-semibold text-neutral-700 mb-2">Organization Name <span class="text-neutral-400 font-normal">(optional)</span></label>
                                        <input type="text" id="organization" x-model="organization" class="w-full bg-neutral-50 border border-neutral-200 text-neutral-900 text-sm rounded-xl focus:ring-2 focus:ring-accent-500 focus:border-accent-500 block p-3 transition-colors hover:border-neutral-300" placeholder="Acme Corp">
                                    </div>
                                    {{-- Subject --}}
                                    <div>
                                        <label for="subject" class="block text-sm font-semibold text-neutral-700 mb-2">Topic</label>
                                        <select id="subject" x-model="subject" class="w-full bg-neutral-50 border border-neutral-200 text-neutral-900 text-sm rounded-xl focus:ring-2 focus:ring-accent-500 focus:border-accent-500 block p-3 transition-colors hover:border-neutral-300 appearance-none">
                                ...
                                <div>
                                    ...
                                    <textarea id="message" x-model="message" rows="5" class="w-full bg-neutral-50 border border-neutral-200 text-neutral-900 text-sm rounded-xl focus:ring-2 focus:ring-accent-500 focus:border-accent-500 block p-3 transition-colors hover:border-neutral-300 resize-y" placeholder="How can we help you?" required></textarea>
                                </div>
                        ...
                        <div x-show="success" x-transition class="text-center py-12 px-6 animate-fade-up">
                            ...
                            <h3 class="text-2xl font-extrabold text-neutral-900 mb-3">Message Sent!</h3>
                            <p class="text-neutral-500 text-sm leading-relaxed max-w-sm mx-auto mb-6">
                                Thank you for reaching out. A team member will get back to you shortly at <span class="font-bold text-neutral-900" x-text="email"></span>.
                            </p>
                            <div class="text-[11px] font-semibold text-neutral-400 bg-neutral-50 border border-neutral-100 rounded-lg p-2.5 max-w-sm mx-auto">
                ...
                <div class="lg:col-span-5 space-y-4">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold text-neutral-900 mb-6">Prefer a Direct Line?</h3>
                        <div class="space-y-4">
                            {{-- Sales --}}
                            <div class="p-5 bg-white rounded-2xl border border-neutral-200 shadow-sm hover:shadow-md hover:border-accent-200 transition-all flex items-start gap-4 group">
                                ...
                                <div>
                                    <h4 class="font-bold text-neutral-900">Sales</h4>
                                    <p class="text-sm text-neutral-600 mt-1 mb-3 leading-relaxed">Questions about plans or getting your organization set up.</p>
                                    <div class="flex flex-col sm:flex-row flex-wrap gap-2">
                                        <a href="mailto:sales@timenest.io" class="inline-flex items-center gap-2 px-3.5 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-700 hover:bg-accent-50 hover:text-accent-600 hover:border-accent-200 transition-all text-xs font-semibold">
                                            <svg class="w-3.5 h-3.5 text-neutral-400 group-hover:text-accent-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                            sales@timenest.io
                                        </a>
                                        <a href="tel:+919876543210" class="inline-flex items-center gap-2 px-3.5 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-700 hover:bg-accent-50 hover:text-accent-600 hover:border-accent-200 transition-all text-xs font-semibold">
                            ...
                            {{-- Support --}}
                            <div class="p-5 bg-white rounded-2xl border border-neutral-200 shadow-sm hover:shadow-md hover:border-blue-200 transition-all flex items-start gap-4 group">
                                ...
                                <div>
                                    <h4 class="font-bold text-neutral-900">Support</h4>
                                    <p class="text-sm text-neutral-600 mt-1 mb-3 leading-relaxed">Already using TimeNest and need help?</p>
                                    <div class="flex flex-col sm:flex-row flex-wrap gap-2">
                                        <a href="mailto:support@timenest.io" class="inline-flex items-center gap-2 px-3.5 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-700 hover:bg-accent-50 hover:text-accent-600 hover:border-accent-200 transition-all text-xs font-semibold">
                                            <svg class="w-3.5 h-3.5 text-neutral-400 group-hover:text-accent-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                            support@timenest.io
                                        </a>
                                        <a href="tel:+919876543211" class="inline-flex items-center gap-2 px-3.5 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-700 hover:bg-accent-50 hover:text-accent-600 hover:border-accent-200 transition-all text-xs font-semibold">
                                            <svg class="w-3.5 h-3.5 text-neutral-400 group-hover:text-accent-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                            +91 98765 43211
                                        </a>
                                    </div>
                            ...
                            {{-- General --}}
                            <div class="p-5 bg-white rounded-2xl border border-neutral-200 shadow-sm hover:shadow-md hover:border-neutral-300 transition-all flex items-start gap-4 group">
                                <div class="w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center shrink-0 group-hover:bg-neutral-600 transition-colors">
                                    <svg class="w-5 h-5 text-neutral-600 group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                    </svg>
                                </div>
                                <div>
                                    <h4 class="font-bold text-neutral-900">General</h4>
                                    <p class="text-sm text-neutral-600 mt-1 mb-3 leading-relaxed">Anything else — partnerships, press, or just saying hi.</p>
                                    <div class="flex flex-col sm:flex-row flex-wrap gap-2">
                                        <a href="mailto:hello@timenest.io" class="inline-flex items-center gap-2 px-3.5 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-700 hover:bg-accent-50 hover:text-accent-600 hover:border-accent-200 transition-all text-xs font-semibold">
                                            <svg class="w-3.5 h-3.5 text-neutral-400 group-hover:text-accent-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                            hello@timenest.io
                                        </a>
                                        <a href="tel:+919876543212" class="inline-flex items-center gap-2 px-3.5 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-700 hover:bg-accent-50 hover:text-accent-600 hover:border-accent-200 transition-all text-xs font-semibold">
                                            <svg class="w-3.5 h-3.5 text-neutral-400 group-hover:text-accent-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                            +91 98765 43212
                                        </a>
                                    </div>
        ...
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px] relative z-10">
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <a href="{{ route('frontend.security') }}" class="group p-6 bg-white/5 rounded-2xl border border-white/10 shadow-none hover:border-white/20 transition-all text-center">
                    ...
                    <p class="text-sm text-neutral-400 font-medium flex items-center justify-center gap-1">Read more <svg class="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg></p>
                </a>
    ...
    <section class="relative py-16 lg:py-24 bg-neutral-50 z-10 overflow-hidden">
        ...
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px] relative z-10">
            <div class="max-w-4xl mx-auto text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-neutral-900 tracking-tight mb-4">What Happens Next</h2>
            ...
            <div class="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto">
                {{-- Step 1: Enquiry --}}
                <div class="group relative bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm hover:shadow-xl hover:border-accent-200 transition-all duration-300 text-center">
                    ...
                    <h4 class="font-bold text-neutral-900 mb-2 text-lg">Enquiry</h4>
                    <p class="text-sm text-neutral-500 leading-relaxed">Your message lands directly in our team inbox — no bots, no filters.</p>
                </div>

                {{-- Step 2: Discussion --}}
                <div class="group relative bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300 text-center">
                    <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    ...
                    <h4 class="font-bold text-neutral-900 mb-2 text-lg">Discussion</h4>
                    <p class="text-sm text-neutral-500 leading-relaxed">A founder reads your message and responds to understand your exact needs.</p>
                </div>

                {{-- Step 3: Demo --}}
                <div class="group relative bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm hover:shadow-xl hover:border-emerald-200 transition-all duration-300 text-center">
                    <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    ...
                    <h4 class="font-bold text-neutral-900 mb-2 text-lg">Live Demo</h4>
                    <p class="text-sm text-neutral-500 leading-relaxed">We walk you through TimeNest live, answering every question in real time.</p>
                </div>

                {{-- Step 4: Onboarding --}}
                <div class="group relative bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm hover:shadow-xl hover:border-purple-200 transition-all duration-300 text-center">
                    <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    ...
                    <h4 class="font-bold text-neutral-900 mb-2 text-lg">Onboarding</h4>
                    <p class="text-sm text-neutral-500 leading-relaxed">We help you get your organization fully set up and running smoothly.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 lg:py-28 relative overflow-hidden bg-neutral-900 mt-12">
        ...
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px] relative z-10 text-center">
            ...
            <p class="text-xl text-neutral-300 max-w-2xl mx-auto mb-10 leading-relaxed">
