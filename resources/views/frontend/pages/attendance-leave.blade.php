...
<section class="py-20 lg:py-32 bg-black border-y border-neutral-800 relative overflow-hidden">
            ...
            <div class="order-2 lg:order-1">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-neutral-300 font-medium">Configurable geo-fence radius, set per branch</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-accent-500/20 flex items-center justify-center text-accent-400 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-300 font-medium">Check-ins verified against real-time location, not self-reported</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-accent-500/20 flex items-center justify-center text-accent-400 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-300 font-medium">Multiple branches can run different attendance rules at once</span>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-neutral-700 font-medium">Custom leave types and balances, configurable per organization</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-accent-100 flex items-center justify-center text-accent-600 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-700 font-medium">Policy changes never rewrite already-approved history</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-accent-100 flex items-center justify-center text-accent-600 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-700 font-medium">Employees see their real-time balance before requesting</span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="order-2 lg:order-1">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-neutral-300 font-medium">Auto-approval for policies that don't need manual review</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-300 font-medium">Single-approval for straightforward requests</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-300 font-medium">Multi-level approval for requests that need a chain of sign-offs</span>
                    </li>
                </ul>
            </div>
            <div class="order-1 lg:order-2">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-neutral-700 font-medium">Routes to the direct reporting manager first</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-accent-100 flex items-center justify-center text-accent-600 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-700 font-medium">Falls back to department head automatically if needed</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-accent-100 flex items-center justify-center text-accent-600 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-700 font-medium">Self-approval is never permitted, at any level</span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="order-2 lg:order-1">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-neutral-300 font-medium">Daily worklogs tied to attendance, not tracked separately</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="mt-1 w-6 h-6 rounded-full bg-accent-500/20 flex items-center justify-center text-accent-400 flex-shrink-0">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-neutral-300 font-medium">Gives managers real context, not just presence data</span>
                    </li>
                </ul>
            </div>
            <div class="order-1 lg:order-2">
