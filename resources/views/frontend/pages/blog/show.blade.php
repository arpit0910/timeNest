<x-frontend-layout.app metaTitle="{{ ucwords(str_replace('-', ' ', $slug)) }} â€” TimeNest Blog">
    <section class="relative pt-32 pb-20 bg-surface">
        <div class="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <h1 class="font-display text-3xl lg:text-4xl font-bold text-white mb-4">{{ ucwords(str_replace('-', ' ', $slug)) }}</h1>
            <p class="text-slate-500 text-sm mb-8">Published on January 15, 2025 Â· 5 min read</p>
            <div class="text-slate-400 font-body leading-relaxed space-y-4">
