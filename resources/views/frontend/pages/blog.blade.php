    ...
    <main x-data="{ searchQuery: '', activeCategory: 'All' }" class="flex-grow pb-20 bg-slate-50 relative overflow-hidden">
        ...
        <section class="px-6 mt-16 mb-24 max-w-7xl mx-auto border-t border-slate-200 pt-24">
            <div class="text-center max-w-3xl mx-auto mb-12">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Latest Posts</h2>
                <p class="text-lg text-slate-600">Catch up on our newest thoughts and strategies for modern workforce management.</p>
                <div class="mt-10">
                    {{-- Search Input --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {{-- Grid Post 1 --}}
                <a href="#" x-show="(activeCategory === 'All' || activeCategory === 'Workforce Management') && (searchQuery === '' || $el.innerText.toLowerCase().includes(searchQuery.toLowerCase()))" class="post-card group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                ...
                {{-- Grid Post 2 --}}
                <a href="#" x-show="(activeCategory === 'All' || activeCategory === 'Security & Compliance') && (searchQuery === '' || $el.innerText.toLowerCase().includes(searchQuery.toLowerCase()))" class="post-card group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                    <div class="h-52 overflow-hidden bg-slate-100">
                ...
                {{-- Grid Post 3 --}}
                <a href="#" x-show="(activeCategory === 'All' || activeCategory === 'Growing Teams') && (searchQuery === '' || $el.innerText.toLowerCase().includes(searchQuery.toLowerCase()))" class="post-card group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                    <div class="h-52 overflow-hidden bg-slate-100">
                ...
                {{-- Grid Post 5 --}}
                <a href="#" x-show="(activeCategory === 'All' || activeCategory === 'Remote & Hybrid Work') && (searchQuery === '' || $el.innerText.toLowerCase().includes(searchQuery.toLowerCase()))" class="post-card group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                    <div class="h-52 overflow-hidden bg-slate-100">
        ...
        <section class="px-6 py-24 bg-slate-100">
        ...
        <section class="mb-24 py-24">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Most Popular</h2>
                    <p class="text-lg text-slate-600">The articles that have resonated most with leaders and managers.</p>
                </div>
        ...
        <section class="max-w-4xl mx-auto px-6 mb-24">
            <div class="text-center max-w-3xl mx-auto mb-12">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Quick Reads</h2>
                <p class="text-lg text-slate-600">Short takes and updates that only take a minute.</p>
            </div>
