    ...
    <section class="min-h-[85vh] flex flex-col justify-center relative pt-32 pb-16 lg:pt-48 lg:pb-24 overflow-hidden bg-black">
        ...
        <div class="relative max-w-7xl mx-auto px-6 text-center z-10">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold text-white tracking-tight mb-8 leading-[1.1]">
                ...
                <span class="text-neutral-300">Outgrow Simple Tools</span>
            </h1>
            
            <p class="text-xl md:text-2xl text-neutral-400 max-w-3xl mx-auto leading-relaxed">
                TimeNest exists because most workforce tools force you to pick between "too simple" and "too complicated" â€” nothing built for the actual in-between of a freelancer becoming a team, and a team becoming an organization.
            </p>
        </div>
    </section>

    {{-- Why We're Building TimeNest --}}
    <section class="py-16 lg:py-24 bg-black relative overflow-hidden border-y border-neutral-800">
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px]">
            <div class="max-w-3xl mx-auto flex flex-col items-center text-center">
                ...
                <div class="prose prose-lg text-neutral-400 mx-auto">
                    <p class="mb-6 leading-relaxed text-lg">
                        Freelancers track time in notebooks or spreadsheets. Small teams run attendance off a WhatsApp group and a shared Excel sheet. By the time a company is large enough to afford "proper" enterprise software, they've already spent years duct-taping tools together â€” and migrating years of scattered data is its own project.
                    </p>
    ...
    <section class="py-16 lg:py-24 bg-white relative">
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px]">
            <div class="max-w-4xl mx-auto flex flex-col items-center mb-16 text-center">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-neutral-900 tracking-tight">A few things we don't compromise on</h2>
            </div>
            
            <div class="grid md:grid-cols-2 gap-x-12 gap-y-12 max-w-5xl mx-auto">
                <div>
                    <h3 class="text-xl font-bold text-neutral-900 mb-3">1. Identity and business are separate.</h3>
                    <p class="text-neutral-600 leading-relaxed">
                        A person's account isn't tied to one company. You can work independently, own an organization, and be invited into someone else's workspace â€” all on the same account.
                    </p>
                </div>
                <div>
                    <h3 class="text-xl font-bold text-neutral-900 mb-3">2. Structure should be earned, not forced.</h3>
                    <p class="text-neutral-600 leading-relaxed">
                        Organization setup, roles, and departments show up when you actually need them â€” not on day one, just because a template says so.
                    </p>
                </div>
                <div>
                    <h3 class="text-xl font-bold text-neutral-900 mb-3">3. Access is never hardcoded.</h3>
                    <p class="text-neutral-600 leading-relaxed">
                ...
                <div>
                    <h3 class="text-xl font-bold text-neutral-900 mb-3">4. Every organization's data stays walled off.</h3>
                    <p class="text-neutral-600 leading-relaxed">
                        Multi-tenancy isn't an afterthought â€” it's checked on every request, not assumed by default.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px]">
            <div class="max-w-3xl mx-auto flex flex-col items-center text-center">
                ...
                <p class="text-lg text-neutral-400 mb-8 leading-relaxed">
                    TimeNest is designed to work the same way for a solo freelancer, a growing startup, and a multi-department organization â€” the difference is what unlocks as you grow, not a different product entirely.
                </p>
    ...
    <section class="py-16 lg:py-24 bg-white relative">
        <div class="container mx-auto px-6 lg:px-8 xl:px-12 2xl:max-w-[1440px]">
            <div class="max-w-3xl mx-auto flex flex-col items-center text-center">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-neutral-900 tracking-tight mb-6">Engineered like it has to last</h2>
                <p class="text-lg text-neutral-600 leading-relaxed text-center">
                    TimeNest is built as a real production platform, not a quick MVP held together with shortcuts. That means proper tenant isolation, permission-driven access instead of hardcoded roles, encrypted sessions, and architecture designed to support new modules without rewrites â€” because workforce data is not something to get wrong.
                </p>
            </div>
        </div>
    </section>
