    ...
    <section class="relative pt-32 pb-20 bg-surface">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center mb-20">
                <div>
                    <x-frontend-base.badge color="indigo" class="mb-4">For Freelancers</x-frontend-base.badge>
                    ...
                    <div class="space-y-3">
                        @foreach([
                            ...
                            <div class="rounded-lg bg-surface p-4 border border-surface-border">
                                <h3 class="font-display text-sm font-semibold text-content-strong mb-2 flex items-center gap-2">{{ $tier }} @if($color === 'amber')<x-frontend-base.badge color="orange" variant="pro">PRO</x-frontend-base.badge>@endif</h3>
