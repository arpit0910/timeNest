    ...
    <section class="relative pt-32 pb-20 bg-surface">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="max-w-3xl mx-auto text-center mb-16">
                ...
                <h1 class="font-display text-4xl lg:text-5xl font-bold text-white mb-4">Freelance Workspace</h1>
                <p class="text-slate-400 text-lg">Not an organization. Not a solo freelancer. A collaborative workspace for freelance teams, agencies, and creative studios.</p>
            ...
            <div class="max-w-4xl mx-auto rounded-xl border border-surface-border overflow-hidden mb-16">
                <table class="w-full text-sm">
                    <thead><tr class="bg-surface-card"><th class="p-4 text-left text-slate-400">Aspect</th><th class="p-4 text-center text-slate-400">Freelancer</th><th class="p-4 text-center text-brand-400">Workspace</th><th class="p-4 text-center text-slate-400">Organization</th></tr></thead>
                    <tbody>
                        @foreach([
                            ...
                            <tr class="border-t border-surface-border"><td class="p-4 text-white">{{ $aspect }}</td><td class="p-4 text-center text-slate-400">{{ $freelancer }}</td><td class="p-4 text-center text-brand-400">{{ $workspace }}</td><td class="p-4 text-center text-slate-400">{{ $org }}</td></tr>
                        @endforeach
                    </tbody>
                </table>
            </div>
