...
class SecurityHardeningTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->appOwnerRole = Role::create([
            'name' => SystemRole::APP_DIRECTOR->value,
            'guard_name' => 'api',
    ...
    public function test_app_owner_can_select_any_organization_without_membership(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.role', SystemRole::APP_DIRECTOR->value)
            ->assertJsonStructure([
                'success',
                'data' => [
                    'access_token',
    ...
    public function test_app_owner_can_access_organization_apis_directly_with_platform_token_via_header(): void
    {
        ...
        $token = $this->issueJwtAction->issueAccessToken($this->appOwner, null, \App\Enums\Guard::PLATFORM, SystemRole::APP_DIRECTOR->value);
